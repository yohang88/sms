<div class="page-sidebar">
    <ul class="nav nav-tabs nav-stacked">
        ...
        <li class="<?php echo active_link('inbox'); ?>"><a href="<?php echo site_url('inbox'); ?>"><i class="icon-envelope"></i> Kotak Masuk <span id="counter_inbox" class="badge badge-success"></span></a></li>
        <li class="<?php echo active_link('outbox'); ?>"><a href="<?php echo site_url('outbox'); ?>"><i class="icon-share-alt"></i> Antrian Kirim <span id="counter_outbox" class="badge badge-warning"></span></a></li>
        <li class="<?php echo active_link('sent'); ?>"><a href="<?php echo site_url('sent'); ?>"><i class="icon-ok"></i> Terkirim</a></li>
        <li class="<?php echo active_link('failed'); ?>"><a href="<?php echo site_url('failed'); ?>"><i class="icon-remove"></i> Gagal Terkirim <span id="counter_failed" class="badge badge-important"></span></a></li>
