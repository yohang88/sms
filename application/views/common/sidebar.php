<div class="page-sidebar">
    <ul class="nav nav-tabs nav-stacked">
        ...
        <li class="<?php echo active_link('inbox'); ?>"><a href="<?php echo site_url('inbox'); ?>"><i class="icon-envelope"></i> Kotak Masuk <span id="counter_inbox" class="badge badge-success pull-right"></span></a></li>
